...
public class CameraConstants {
    ...
    public static final Transform3d LOCALIZATION_CAM_TWO_OFFSET = new Transform3d(new Translation3d(0.2889225, -0.222, 0.1143), new Rotation3d(0, Math.toRadians(20), Math.toRadians(39))); //I am very suspicious of this.
}